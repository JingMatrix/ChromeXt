...
private const val SQL_CREATE_ENTRIES =
    "CREATE TABLE script (id TEXT PRIMARY KEY, match TEXT NOT NULL, grant TEXT NOT NULL, exclude TEXT NOT NULL, meta TEXT NOT NULL, code TEXT NOT NULL, runAt TEXT NOT NULL, shouldWrap TEXT NOT NULL);"
